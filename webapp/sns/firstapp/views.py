...
def groups(request):
    ...
    return render(request, 'firstapp/groups.html', params)
...
def creategroup(request):
    ...
    return redirect(to='/firstapp/groups')
...
def post(request):
    ...
    return render(request, 'firstapp/post.html', params)
...
def share(request, share_id):
    ...
    return render(request, 'firstapp/share.html', params)
